...
public class OptionalGUI extends JFrame {
	...
	private void insertRuleWindow()
	{
		...
		combo_numcheck.addItemListener
		(
				new ItemListener()
				{
					@Override
		...
		combo_ascendcheck.addItemListener
		(
				new ItemListener()
				{
					@Override
	...
	private void helpAboutWindow()
	{
		...
		JLabel label_ourinfo = new JLabel(
				"<html>컴퓨터학부 2013105030 김한영(조장)" + "<html><br />" + 
				"컴퓨터학부 2013105027 김준우" + "<html><br />" + 
				"컴퓨터학부 2013105047 박정현" + "<html><br />" + 
				"컴퓨터학부 2013105063 유창재" + "<html><br />" + 
				"컴퓨터학부 2013105106 홍창민" + "<html><br />" + 
				"컴퓨터학부 2013105121 황진커" +"<html><br />" + 
				"기타 문의" + "<html><br />" + "E-mail : yha1483@naver.com" + "<html><br />"
	  			+ "       : qwertyazsxc@gmail.com"
				);
